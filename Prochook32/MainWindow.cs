namespace Prochook32
{
    ...
    public partial class MainWindow : Form
    {
        ...
        private void startButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Thirty2BitHookWrapper.StartMonitoring();
                this.isHooked = true;
            }
        }
        ...
        private void getText_Click(object sender, EventArgs e)
        {
            ...
            Thirty2BitHookWrapper.GetTextBuffer(buffer, ref bufferSize);
            ...
            Thirty2BitHookWrapper.GetKeyBuffer(buffer, ref bufferSize);
        ...
        private void stopButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Thirty2BitHookWrapper.StopMonitoring();
                this.isHooked = false;
            }
        }
    }
