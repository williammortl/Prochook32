...
void WINAPI CreateAllHooks(void)
{
	if (_bIsRootApp == FALSE)
	{
		...
		{
			_bIsHooked = TRUE;
			CreateHook((unsigned __int32)ExtTextOutA, (unsigned __int32)ShadowExtTextOutA, (PHOOKREC)&_hrExtTextOutA);
			CreateHook((unsigned __int32)ExtTextOutW, (unsigned __int32)ShadowExtTextOutW, (PHOOKREC)&_hrExtTextOutW);
			CreateHook((unsigned __int32)TextOutA, (unsigned __int32)ShadowTextOutA, (PHOOKREC)&_hrTextOutA);
			CreateHook((unsigned __int32)TextOutW, (unsigned __int32)ShadowTextOutW, (PHOOKREC)&_hrTextOutW);
		}
	}
...
void WINAPI HookFunction(PHOOKREC phr)
{
	...
	memcpy((void *)phr->ui32AddressFunc, (const void *)&phr->phNew, sizeof(PROCHOOK));
...
void WINAPI UnhookFunction(PHOOKREC phr)
{
	...
	memcpy((void *)phr->ui32AddressFunc, (const void *)&phr->phOld, sizeof(PROCHOOK));
